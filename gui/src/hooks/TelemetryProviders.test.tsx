...
vi.mock("../context/Auth", () => ({
  ...
  useAuth: () => ({
    session: {
      account: {
        id: "test@gourmand.dev", // Mock Gobi team member email
      },
    },
  }),
}));

// Mock isGobiTeamMember utility
vi.mock("../util/isGobiTeamMember", () => ({
  isGobiTeamMember: vi.fn(() => true), // Mock as Gobi team member
}));
