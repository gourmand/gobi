---
title: "Contributing to Gobi Documentation"
sidebarTitle: "Docs Contributions"
description: "Welcome to the Gobi documentation! We're excited that you want to contribute. This guide will help you get started with our documentation workflow and tools."
---
...
<Steps>
  <Step title="Install the agent from Gobi Hub">
...
<Steps>
  ...
  <Step title="Add the Gobi Docs MCP">
    Install from Gobi Hub: https://hub.gourmand.dev/gourmand/gobi-docs-mcp
    
    This MCP provides context about Gobi's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from Gobi Hub: https://hub.gourmand.dev/mintlify/technical-writing-rule
