---
title: "Introduction"
description: "Gobi Hub provides a central registry for creating, managing, and sharing agents, prompts, rules, MCP servers, models, etc. with organization-level governance and configuration"
---
