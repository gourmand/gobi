...
description: "Learn how to create and remix reusable configuration options in Gobi Hub for sharing configuration components like models, prompts, and tools with customizable inputs and template variables"
---
