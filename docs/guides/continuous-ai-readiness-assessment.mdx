...
<CardGroup cols={2}>
  <Card
    title="Building Async Agents with Gobi CLI"
    icon="blog"
    href="https://blog.gourmand.dev/building-async-agents-with-gobi-cli/"
  >
  ...
  <Card
    ...
    icon="book"
    href="https://docs.gourmand.dev/guides/continuous-ai"
  >
