...
description: "Measure and optimize web performance with Chrome DevTools MCP, automated performance traces, and Core Web Vitals monitoring using Gobi."
...
<CardGroup cols={2}>
  ...
  <Card title="Gobi Hub" icon="circle-nodes" href="https://hub.gourmand.dev">
