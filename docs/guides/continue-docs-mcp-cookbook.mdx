---
title: "Contributing to Gobi with Model Context Protocol (MCP)"
description: "Use the Gobi Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows."
sidebarTitle: "Gobi Docs MCP Cookbook"
---
