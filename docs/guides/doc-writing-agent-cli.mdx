---
title: "Automating Documentation Updates with Gobi CLI"
sidebarTitle: "Automating Documentation Updates with Gobi CLI"
description: "Learn how to create automated documentation generation workflows using Gobi CLI. Set up AI agents to analyze code changes and generate or update documentation automatically in GitHub workflows or local development."
---
...
<CardGroup cols={1}>
  ...
  <Card title="Gobi API Key" icon="key">
  ...
  write-docs:
    ...
    - name: Generate documentation with Gobi CLI
      run: |
        ...
        cn --config <gobi-user>/<agent-config> \
           --auto \
           --allow Write \
           -p \
           --prompt ./context.txt \
...
<CardGroup cols={2}>
  <Card title="Gobi CLI Guide" icon="terminal" href="/guides/cli">
  ...
  <Card title="Gobi Hub" icon="users" href="https://hub.gourmand.dev">
