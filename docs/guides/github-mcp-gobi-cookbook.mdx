---
title: "GitHub Issues and PRs with GitHub MCP and Gobi"
description: "Use Gobi and the GitHub MCP to list, summarize, and act on open issues and recently merged pull requests with natural language prompts."
sidebarTitle: "GitHub Issues with Gobi"
---
...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via Gobi Hub">
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Create a New Agent on Gobi Hub">
...
<CardGroup cols={2}>
  <Card title="GitHub MCP (Anthropic)" icon="link" href="https://hub.gourmand.dev/anthropic/github-mcp">
    Anthropic GitHub MCP on Gobi Hub
  </Card>
  <Card title="MCP in Gobi" icon="book" href="/customize/deep-dives/mcp">
    How MCP works with Gobi agents
  </Card>
  <Card title="GitHub Manager AI Agent" icon="robot" href="https://hub.gourmand.dev/gobi/github-manager-ai">
