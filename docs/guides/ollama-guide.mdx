---
title: "Using Ollama with Gobi: A Developer's Guide"
description: "Complete guide to setting up Ollama with Gobi for local AI development. Learn installation, configuration, model selection, performance optimization, and troubleshooting for privacy-focused offline coding assistance"
---
...
```yaml title="~/.gobi/configs/config.yaml"
...
_This guide is based on Ollama v0.11.x and Gobi v1.1.x. Please check for updates regularly._
