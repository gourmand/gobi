---
title: "How to Run Gobi Without Internet"
description: "Learn how to set up Gobi for air-gapped or offline environments using local models, including steps to disable telemetry and configure local model providers"
---
