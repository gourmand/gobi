---
title: "Developer & Team Workflows with Notion + Gobi CLI"
description: "Use Gobi CLI with Notion to generate docs, manage tasks, and automate project workflows – all through natural-language prompts."
sidebarTitle: "Notion with Gobi"
---
