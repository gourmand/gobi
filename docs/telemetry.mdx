...
title: "Telemetry"
icon: "chart-line"
description: "Learn about Gobi's anonymous telemetry collection practices, what usage data is tracked, and how to opt out of data collection to maintain your privacy preferences"
---
...
For `cn`, the Gobi CLI, set the environment variable `GOBI_CLI_ENABLE_TELEMETRY=0` before running commands:

```bash
export GOBI_CLI_ENABLE_TELEMETRY=0
cn <your prompt>
```
...
```bash
GOBI_CLI_ENABLE_TELEMETRY=0 cn <your prompt>
```
