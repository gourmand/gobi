---
title: "FAQs"
description: "Frequently asked questions about Gobi"
---
...
2. **Workspace Gobi folder**: Place a `.env` file in `<workspace-root>/.gobi/.env`  
...
- **Per-workspace**: `<workspace-root>/.env` or `<workspace-root>/.gobi/.env`
- **Global**: `~/.gobi/.env`
