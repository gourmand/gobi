---
title: "MCP servers"
description: "Learn how to use Model Context Protocol (MCP) blocks in Gobi to integrate external tools, connect databases, and extend your development environment."
---
