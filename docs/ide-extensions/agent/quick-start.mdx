---
title: "Quick Start"
description: "Get started with Gobi's Agent mode to automatically implement code changes, fix bugs, and run commands using AI-powered tools that can modify your codebase based on natural language instructions"
---
