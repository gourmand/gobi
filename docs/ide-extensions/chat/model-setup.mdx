---
title: "Recommended Models for Chat in Gobi"
description: "Choose the best chat model for Gobi, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
