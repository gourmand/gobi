...
1. Gobi sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by Gobi. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/gourmand/gobi/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
