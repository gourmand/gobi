---
title: "Gobi Autocomplete Setup and Configuration Guide"
description: "Step-by-step guide to setting up and configuring autocomplete in Gobi, including Codestral, Ollama, and IDE settings."
