---
title: "Cloudflare"
description: "Configure Cloudflare Workers AI with Gobi to access various models for chat and autocomplete, including Llama 3 8B and DeepSeek Coder through Cloudflare's serverless AI platform"
---
