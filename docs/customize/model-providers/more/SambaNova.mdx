---
title: "SambaNova"
description: "Configure SambaCloud with Gobi to access their high-performance platform for running large AI models, including Llama 4 Scout with world record open source model performance"
---
