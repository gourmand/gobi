---
title: "Venice AI"
description: "Configure Venice AI with Gobi to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.gobi/config.json` to look like the following.
