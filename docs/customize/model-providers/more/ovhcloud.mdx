---
title: "OVHcloud"
description: "Configure OVHcloud AI Endpoints with Gobi to access their GDPR-compliant serverless inference API for models like Qwen, Llama, Mistral, and Deepseek, with strong security and data privacy features"
---
