...
description: "Configure Function Network with Gobi to access private and affordable AI models, including Llama 3.1, Qwen2.5-Coder, and various embedding models for a user-owned AI experience"
---
