...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  focusGobiInput: [undefined, void];
  focusGobiInputWithoutClear: [undefined, void];
  focusGobiInputWithNewSession: [undefined, void];
  ...
  focusGobiSessionId: [{ sessionId: string | undefined }, void];
