...
import { IGobiServerClient } from "../../gobiServer/interface";
...
export const testGobiServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IGobiServerClient;

const mockGobiServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IGobiServerClient;
