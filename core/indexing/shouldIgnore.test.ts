...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .gobiignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".gobiignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .gobiignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".gobiignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.gobiignore", "level3/"],
    ]);
    const result = await shouldIgnore(
