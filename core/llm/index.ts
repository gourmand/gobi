...
import { findLlmInfo } from "@gourmanddev/llm-info";
import {
    BaseLlmApi,
...
export abstract class BaseLLM implements ILLM {
  ...
  /**
   * This exists because for the gobi-proxy, sometimes we want to get the value of the underlying provider that is used on the server
  ...
  constructor(_options: LLMOptions) {
    ...
    // Use @gourmanddev/llm-info package to autodetect certain parameters
    const modelSearchString =
      this.providerName === "gobi-proxy"
  ...
  private _modifyCompletionOptions(
    ...
    // See these threads:
    // - https://github.com/gourmand/gobi/issues/3698
