...
import GobiProxy from "./GobiProxy.js";

vi.mock("@gourmanddev/config-yaml", async (importOriginal) => {
...
describe("GobiProxy", () => {
  ...
  test("rerank should send a valid request", async () => {
    const proxy = new GobiProxy({
      apiKey: "test-api-key",
      model: "test-model",
      apiBase: "https://proxy.gourmand.dev/model-proxy/v1/",
    });
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.gourmand.dev/model-proxy/v1/rerank",
        method: "POST",
        headers: {
  ...
  test("streamChat should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.gourmand.dev/model-proxy/v1/chat/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
          "api-key": "test-api-key",
          "x-gobi-unique-id": "NOT_UNIQUE",
        },
        body: {
          model: "test-model",
  ...
  test("streamFim should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.gourmand.dev/model-proxy/v1/fim/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  test("embed should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.gourmand.dev/model-proxy/v1/embeddings",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("listModels should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      params: [],
      expectedRequest: {
        url: "https://proxy.gourmand.dev/model-proxy/v1/models",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
