 ...
 *
 * See here for details: https://github.com/gourmand/gobi/issues/940
 */
...
async function showUnsupportedCpuToast(ide: IDE) {
  ...
  if (shouldOpenLink) {
    void ide.openUrl(
      "https://docs.gourmand.dev/troubleshooting#i-received-a-codebase-indexing-disabled---your-linux-system-lacks-required-cpu-features-avx2-fma-notification",
    );
  }
}
