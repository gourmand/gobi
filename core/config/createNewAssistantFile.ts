...
# To learn more, see the full config.yaml reference: https://docs.gourmand.dev/reference
...
# https://docs.gourmand.dev/customization/models
models:
  - name: my gpt-5
    provider: openai
    model: gpt-5
...
# MCP Servers that Gobi can access
# https://docs.gourmand.dev/customization/mcp-tools
mcpServers:
