...
describe("SentryLogger Integration Tests", () => {
  ...
  describe("Telemetry Toggle Behavior", () => {
    ...
    it("should not initialize in test environment even when telemetry is enabled", async () => {
      ...
      // In the updated implementation, the Gobi team member check is used instead of NODE_ENV check
          ...
          values: [
            {
              stacktrace: {
                frames: [
                  {
                    filename: "/Users/dev/gobi/core/util/sentry.js",
                    abs_path: "/Users/dev/gobi/core/util/sentry.js",
          ...
          values: [
            {
              stacktrace: {
                frames: [
                  {
                    filename:
                      "C:\\Users\\dev\\gobi\\extensions\\vscode\\src\\extension.js",
                    abs_path:
                      "C:\\Users\\dev\\gobi\\extensions\\vscode\\src\\extension.js",
                  },
                  {
                    filename: "/home/dev/gobi/core/util/sentry.js",
                    abs_path: "/home/dev/gobi/core/util/sentry.js",
                  },
                  {
