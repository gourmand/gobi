...
# It is used to define and reuse prompts within Gobi
...
# To learn more, see the full .prompt file reference: https://docs.gourmand.dev/features/prompt-files
name: Example
