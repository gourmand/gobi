...
# 3. Try asking Gobi to "make this more readable"
...
# 3. Try asking Gobi "what sorting algorithm is this?"
...
# 2. Use the "/init" slash command to generate a GOBI.md file

  # ——————————————————      Learn more at https://docs.gourmand.dev      ——————————————————— #
