package com.github.gourmand.gobiintellijextension.editor

import com.github.gourmand.gobiintellijextension.Icons
import com.github.gourmand.gobiintellijextension.`gobi`.GetTheme
...
import com.github.gourmand.gobiintellijextension.utils.getMetaKeyLabel
import com.github.gourmand.gobiintellijextension.utils.getShiftKeyLabel
...
class CustomPanel(
    ...
    private val subPanelA: JPanel =
        JPanel(MigLayout("insets 0, fillx")).apply {
            val globalScheme = EditorColorsManager.getInstance().globalScheme
            val defaultBackground = globalScheme.defaultBackground
            val gobiSettingsService = service<GobiExtensionSettings>()
            val dropdown =
                JComboBox(modelTitles.toTypedArray()).apply {
                    ...
                    selectedIndex =
                        if (itemCount == 0) -1 else gobiSettingsService.gobiState.lastSelectedInlineEditModel?.let {
                    ...
                    addActionListener {
                        gobiSettingsService.gobiState.lastSelectedInlineEditModel =
