...
import com.github.gourmand.gobiintellijextension.utils.Debouncer
...
class GobiPluginSelectionListener(
    ...
    private fun shouldRemoveTooltip(selectedText: String?, editor: Editor): Boolean {
        return selectedText.isNullOrEmpty() ||
                !service<GobiExtensionSettings>().gobiState.displayEditorTooltip
    }
