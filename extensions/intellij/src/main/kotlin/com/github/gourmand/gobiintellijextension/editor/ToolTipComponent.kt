import com.github.gourmand.gobiintellijextension.actions.FocusActionUtil
import com.github.gourmand.gobiintellijextension.editor.openInlineEdit
...
class ToolTipComponent(editor: Editor, x: Int, y: Int) :
    ...
    init {
        ...
        addToChatButton.addActionListener { e: ActionEvent? ->
            FocusActionUtil.sendHighlightedCodeWithMessageToWebview(editor.project, "focusGobiInputWithNewSession")
