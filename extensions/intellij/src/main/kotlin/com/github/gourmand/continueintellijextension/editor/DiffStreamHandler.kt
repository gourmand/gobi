...
import com.github.gourmand.gobiintellijextension.StreamDiffLinesPayload
...
class DiffStreamHandler(
    ...
    private fun initUnfinishedRangeHighlights() {
        ...
        val unfinishedKey = editorUtils.createTextAttributesKey("GOBI_DIFF_UNFINISHED_LINE", 0x20888888)
    ...
    private fun updateProgressHighlighters(type: DiffLineType) {
        val editorUtils = EditorUtils(editor)
        val curLineKey = editorUtils.createTextAttributesKey("GOBI_DIFF_CURRENT_LINE", 0x40888888)
