...
@Service
class GobiSentryService(
    private val telemetryStatus: GobiTelemetryStatus = service<GobiTelemetryStatusService>()
) {
    private val log = Logger.getInstance(GobiSentryService::class.java.simpleName)
