...
import com.github.gourmand.gobiintellijextension.ApplyState
import com.github.gourmand.gobiintellijextension.ApplyStateStatus
import com.github.gourmand.gobiintellijextension.IDE
import com.github.gourmand.gobiintellijextension.ToastType
import com.github.gourmand.gobiintellijextension.browser.GobiBrowserService.Companion.getBrowser
import com.github.gourmand.gobiintellijextension.editor.DiffStreamHandler
...
import com.github.gourmand.gobiintellijextension.protocol.ApplyToFileParams
...
class ApplyToFileHandler(
    ...
    companion object {
         ...
         */
        suspend fun apply(
            project: Project, gobiPluginService: GobiPluginService, ide: IDE, params: ApplyToFileParams
        ) {
            val editorUtils =
            ...
            val handler = ApplyToFileHandler(
                project, gobiPluginService, ide, params, editorUtils, diffStreamService
            )
