...
import com.github.gourmand.gobiintellijextension.FimResult
import com.github.gourmand.gobiintellijextension.Position
import com.github.gourmand.gobiintellijextension.nextEdit.NextEditJumpManager
import com.github.gourmand.gobiintellijextension.nextEdit.NextEditService
import com.github.gourmand.gobiintellijextension.nextEdit.NextEditStatusService
import com.github.gourmand.gobiintellijextension.nextEdit.NextEditUtils
import com.github.gourmand.gobiintellijextension.nextEdit.NextEditWindowManager
...
class GobiInlineCompletionProvider : InlineCompletionProvider {
    override val id get() = InlineCompletionProviderID("Gobi")
    ...
    override fun isEnabled(event: InlineCompletionEvent): Boolean {
        val isSettingEnabled = GobiExtensionSettings.instance.gobiState.enableTabAutocomplete
