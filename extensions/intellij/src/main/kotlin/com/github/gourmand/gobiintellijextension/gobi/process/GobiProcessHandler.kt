...
class GobiProcessHandler(
    parentScope: CoroutineScope,
    private val process: GobiProcess,
    ...
    private val log = Logger.getInstance(GobiProcessHandler::class.java)
                ...
                while (isActive) {
                    ...
                    if (line != null && line.isNotEmpty()) {
                        try {
                            ...
                            service<GobiSentryService>().report(e, "Error handling message: $line")
                        }
                    } else
                        delay(100)
                }
            } catch (e: IOException) {
                service<GobiSentryService>().report(e)
            }
        }
        scope.launch(Dispatchers.IO) {
