package com.github.gourmand.gobiintellijextension.unit

import com.github.gourmand.gobiintellijextension.autocomplete.GobiInlineCompletionProvider
import com.github.gourmand.gobiintellijextension.autocomplete.CompletionService
...
class GobiInlineCompletionProviderTest : BasePlatformTestCase() {
    ...
    override fun setUp() {
        super.setUp()
        InlineCompletionHandler.registerTestHandler(GobiInlineCompletionProvider(), testRootDisposable)
    }
    ...
    fun `test don't show when settings are disabled`() = myFixture.testInlineCompletion {
        ...
        GobiExtensionSettings.instance.gobiState.enableTabAutocomplete = false
