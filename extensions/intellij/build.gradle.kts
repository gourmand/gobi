...
tasks {
    ...
    test {
        useJUnitPlatform()
        environment("GOBI_GLOBAL_DIR", "${rootProject.projectDir}/src/test/kotlin/com/github/gourmand/gobiintellijextension/test-gobi")
...
val testIntegration = task<Test>("testIntegration") {
    ...
    systemProperty("GOBI_PLUGIN_DIR", tasks.prepareSandbox.get().pluginDirectory.get().asFile)
    environment("GOBI_GLOBAL_DIR", "${rootProject.projectDir}/src/testIntegration/kotlin/com/github/gourmand/gobiintellijextension/test-gobi")
    useJUnitPlatform()
