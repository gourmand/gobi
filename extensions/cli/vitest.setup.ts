...
process.env.GOBI_CLI_ENABLE_TELEMETRY = "0";
process.env.GOBI_ALLOW_ANONYMOUS_TELEMETRY = "0";
...
vi.mock("./src/systemMessage.js", () => ({
  constructSystemMessage: vi
    .fn()
    .mockResolvedValue(
      "You are an agent in the Gobi CLI. Given the user's prompt, you should use the tools available to you to answer the user's question.",
    ),
}));

// Mock environment for tests
process.env.GOBI_GLOBAL_DIR = "/tmp/gobi-test";
