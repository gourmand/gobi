...
describe("FreeTrialTransitionUI - URL Opening Security", () => {
  ...
  it("should verify URL format for models setup", () => {
    ...
    const baseUrl = "https://test.gourmand.dev";
    const expectedUrl = new URL("setup-models", baseUrl).toString();

    expect(expectedUrl).toBe("https://test.gourmand.dev/setup-models");
  });
  ...
  it("should handle URL construction with different base URLs", () => {
    ...
    const testCases = [
      {
        base: "https://gourmand.dev",
        expected: "https://gourmand.dev/setup-models",
      },
      {
        base: "https://app.gourmand.dev",
        expected: "https://app.gourmand.dev/setup-models",
      },
      {
