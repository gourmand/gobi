...
export async function handleMaxedOutFreeTrial(
  ...
  console.log("Choose how you'd like to Gobi:");
  ...
  if (choice === "1" || choice === "") {
    ...
    try {
      ...
      console.log(
        chalk.dim(
          "After setting up your models subscription, restart the CLI to gobi.",
        ),
      );
    } catch {
  ...
  console.log(
    chalk.green(
      "\n🔄 Restarting Gobi CLI to resume your conversation...\n",
    ),
  );
