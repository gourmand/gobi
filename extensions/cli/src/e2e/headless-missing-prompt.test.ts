...
models:
  - model: gpt-4
    ...
    expect(output).toContain('gobi -p "please review my current git diff"');
    expect(output).toContain('echo "hello" | gobi -p');
    expect(output).toContain('gobi -p "analyze the code in src/"');
  });
