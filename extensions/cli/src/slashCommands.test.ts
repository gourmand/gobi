...
vi.mock("./env.js", () => ({
  env: {
    gobiHome: "/home/test/.gobi",
    appUrl: "https://hub.gourmand.dev",
  },
}));
...
vi.mock("./session.js", () => ({
  getSessionFilePath: vi.fn(
    () => "/home/test/.gobi/cli-sessions/gobi-cli-pid-12345.json",
  ),
  ...
  describe("handleSlashCommands", () => {
    ...
    it("should use test session directory when in test mode", async () => {
      ...
      (getSessionFilePath as any).mockReturnValue(
        "/test-home/.gobi/cli-sessions/gobi-cli-test-123.json",
      );
      ...
      expect(result?.output).toContain("/test-home/.gobi/cli-sessions/");
