...
describe("TelemetryService - Session Metadata", () => {
  ...
  beforeEach(() => {
    ...
    process.env.GOBI_CLI_ENABLE_TELEMETRY = "1";
  ...
  describe("recordSessionStart", () => {
    ...
    it("should include is_gobi_remote_agent=true when in remote agent mode", () => {
      // Set Gobi remote agent environment
      process.env.GOBI_REMOTE = "true";
