...
function getGobiProxyModelName(
  packageIdentifier: PackageIdentifier,
  provider: string,
  model: string,
): string {
...
/** The additional properties that are added to the otherwise OpenAI-compatible body when requesting a Gobi proxy */
export const gobiPropertiesSchema = z.object({
...
export type GobiProperties = z.infer<typeof gobiPropertiesSchema>;
