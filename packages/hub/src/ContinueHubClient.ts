...
import { IGobiHubClient } from "./IGobiHubClient.js";

interface GobiHubClientOptions {
  apiKey?: string;
  apiBase?: string;
  fetchOptions?: RequestInit;
}

export class GobiHubClient implements IGobiHubClient {
  private readonly apiKey?: string;
  private readonly apiBase: string;
  private readonly fetchOptions?: RequestInit;

  constructor(options: GobiHubClientOptions) {
    this.apiKey = options.apiKey;
    this.apiBase = options.apiBase ?? "https://api.gourmand.dev";
