...
import { postprocessCompletion } from "../autocomplete/postprocessing";
import { shouldPrefilter } from "../autocomplete/prefiltering";
import { getAllSnippetsWithoutRace } from "../autocomplete/snippets";
...
export class NextEditProvider {
  ...
  private async _prepareLlm(): Promise<ILLM | undefined> {
    ...
    // Temporary fix for JetBrains autocomplete bug as described in https://github.com/gourmand/gobi/pull/3022
