...
import type { FileType, IDE, SlashCommand } from "../../../index";
import { getGlobalGobiIgArray } from "../../../indexing/gobiignore";
...
async function getEntriesFilteredByIgnore(dir: string, ide: IDE) {
  const ig = ignore().add(DEFAULT_IGNORE).add(getGlobalGobiIgArray());
