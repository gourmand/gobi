...
import { AssistantChatMessage, CompletionOptions } from "../index";
...
describe("LLM", () => {
  ...
  testLLM(
    new Azure({
      ...
      apiBase: "https://gobi-azure-openai-instance.openai.azure.com",
  ...
  testLLM(
    new Azure({
      ...
      apiBase: "https://gobi-foundry-resource.services.ai.azure.com",
