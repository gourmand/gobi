...
const testCases: [any, string, boolean, string][] = [
  [GobiProxy, "owner/package/vllm/some-model", false, "vllm provider"],
  [GobiProxy, "owner/package/openai/gpt-4", true, "openai provider"],
  [GobiProxy, "owner/package/anthropic/claude-3", true, "anthropic provider"],
  [GobiProxy, "owner/package/cohere/command-r", true, "cohere provider"],
  [
    GobiProxy,
  ...
  [GobiProxy, "owner/package/groq/llama-model", true, "groq provider"],
