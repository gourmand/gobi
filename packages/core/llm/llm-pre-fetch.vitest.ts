...
import * as openAiAdapters from "@gourmanddev/openai-adapters";
import * as dotenv from "dotenv";
import { beforeEach, describe, expect, test, vi } from "vitest";
import { ChatMessage, ILLM } from "../index";
...
vi.mock("@gourmanddev/fetch");
vi.mock("@gourmanddev/openai-adapters");
