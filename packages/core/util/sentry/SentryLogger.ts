import { Extras, type Event, type Integration } from "@sentry/core";
import * as Sentry from "@sentry/node";
import os from "node:os";
import { IdeInfo } from "../../index.js";
import { isGobiTeamMember } from "../isGobiTeamMember.js";
...
export class SentryLogger {
  ...
  static async setup(
    ...
    SentryLogger.allowTelemetry =
      allowAnonymousTelemetry && isGobiTeamMember(userEmail);
