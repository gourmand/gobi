 ...
 */
export function instanceOfSyncSecretsRequest(value: object): value is SyncSecretsRequest {
...
export function SyncSecretsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SyncSecretsRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SyncSecretsRequestToJSONTyped(value?: SyncSecretsRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
