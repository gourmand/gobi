...
import { GobiFeaturesMenu } from "../components/GobiFeaturesMenu";
...
export function UserSettingsSection() {
  ...
  const gobiAfterToolRejection = config.ui?.gobiAfterToolRejection ?? false;
            ...
            <Card>
              <div className="flex flex-col gap-4">
                <UserSetting
                  ...
                  description="Allows Gobi to send anonymous telemetry."
              ...
              >
                <div className="flex flex-col gap-x-1 gap-y-4">
                  ...
                  <UserSetting
                    ...
                    description=" Gobi will not attempt to use native tool calling and will only use system message tools."
                  ...
                  <UserSetting
                    ...
                    description=" streaming will gobi after the tool call is rejected."
                    value={gobiAfterToolRejection}
                    onChange={(value) =>
                      handleUpdate({ gobiAfterToolRejection: value })
                    }
                  />
