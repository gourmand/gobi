...
function KeyboardShortcut(props: KeyboardShortcutProps) {
  return (
    ...
    >
      <div className="w-full flex-grow pr-4 pb-2 sm:w-auto sm:pb-0">
        <span className="block text-sm break-words">{props.description}:</span>
      </div>
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Gobi Hub"
                description="Visit hub.gourmand.dev to explore custom agents and blocks"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://hub.gourmand.dev/")
                }
              />

              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Gobi"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://docs.gourmand.dev/")
                }
              />
              ...
              <ConfigRow
                ...
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://github.com/gourmand/gobi/issues/new/choose",
                  )
                }
              />
