        ...
        <ModelRoleRow
          ...
          description={
            <span>
              ...
              <a
                href="https://docs.gourmand.dev/features/chat/quick-start"
                target="_blank"
          ...
          setupURL="https://docs.gourmand.dev/chat/model-setup"
        />
        ...
        <ModelRoleRow
          ...
          description={
            <span>
              ...
              <a
                href="https://docs.gourmand.dev/features/autocomplete/quick-start"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit underline hover:brightness-125"
              >
          ...
          onConfigure={handleConfigureModel}
          setupURL="https://docs.gourmand.dev/autocomplete/model-setup"
        />
            ...
            <ModelRoleRow
              ...
              description={
                <span>
                  ...
                  <a
                    href="https://docs.gourmand.dev/features/edit/quick-start"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-inherit underline hover:brightness-125"
                  >
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.gourmand.dev/edit/model-setup"
            />
          </>
        )}
      </Card>
        ...
        >
          <div className="flex flex-col">
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.gourmand.dev/customize/model-roles/apply"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.gourmand.dev/customize/model-roles/embeddings"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.gourmand.dev/customize/model-roles/reranking"
            />
          </div>
        </Toggle>
      </Card>
