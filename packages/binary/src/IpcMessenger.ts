import { IProtocol } from "@gourmanddev/core/protocol/index.js";
import { IMessenger, type Message } from "@gourmanddev/core/protocol/messenger";
  ...
  implements IMessenger<ToProtocol, FromProtocol>
{
  constructor() {
    ...
    process.stdout.on("close", () => {
      ...
      console.log("[info] Exiting Gobi core...");
      process.exit(1);
    });
  ...
  implements IMessenger<ToProtocol, FromProtocol>
{
  ...
  constructor(private readonly subprocess: ChildProcessWithoutNullStreams) {
    ...
    this.subprocess.stdout.on("close", () => {
      console.log("[info] Gobi core exited");
    });
