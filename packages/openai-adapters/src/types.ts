...
export const GobiProxyConfigSchema = BasePlusConfig.extend({
  provider: z.literal("gobi-proxy"),
  env: z.object({
...
export type GobiProxyConfig = z.infer<typeof GobiProxyConfigSchema>;
